...
console.log(this.state.data);
   ...
   console.log(city)
    ...
    return (
        <Card>
            <SubCard> {selectedDate && selectedDate.date && <EachCard city={city} day={selectedDate} key={selectedDate.date}/>}
  ...
  {options.map((option,index)=><option key={index} value={index}>{option.name}</option>)}
                ...
                <Carousel>
                    {list.map((day) => <WeatherCard onParticularDate={this.setDate} day={day} key={day.date} />)}
                </Carousel>
            </CarouselWrapper>
